...
class CreateFirebaseUserInfoImpl(
    ...
    override fun attemptToCreateVideoFirebaseStorageResponseFlow(uri: Uri): Flow<String?> {
        return callbackFlow {
            val storageReference = firebaseStorage.getReference("${Constants.VIDEO}/${System.currentTimeMillis()}")
